...
from ..layers.equiv.sannai import ReyEquiv1to1
...
class ReyNetModel(pl.LightningModule):
    def __init__(self, set_layers, channel_layers, args) -> None:
        super().__init__()
        self.save_hyperparameters()
        self.args = args

        self.model = nn.Sequential(
            ReyEquiv1to1(3, set_layers=set_layers, channel_layers=channel_layers, activation=nn.ReLU(inplace=True)),
            Sumpool(dim=-1),
            nn.Dropout(0.5),
            nn.Linear(channel_layers[-1], 256),
